...
MadCP integration for [Home Assistant](https://www.home-assistant.io/), backed by
[`home-assistant-cli`](https://github.com/home-assistant-ecosystem/home-assistant-cli) (`hass-cli`).

## MCP endpoint

```text
${MADCP_PUBLIC_URL}/servers/homeassistant/mcp
```
...
3. Paste them on `/servers/homeassistant/auth`, or put them in the host `/data/madcp/storage/.env`.
